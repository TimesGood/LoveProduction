...
public class FilesDisplayActivity extends AppCompatActivity implements ReaderCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((mFileUrl == null) || (mFileUrl.length() <= 0)) {
            Toast.makeText(FilesDisplayActivity.this, "获取文件url出错了",
        ...
        if (isLocalExist()) {
            ...
            if (!mFileUrl.contains("http")) {
                new AlertDialog.Builder(FilesDisplayActivity.this)
                        .setTitle("温馨提示:")
