...
public class ReportChannelOneActivity extends BaseActivity<ReportPresenter, ReportContract.View>
    ...
    protected int getLayoutId() {
        return R.layout.activity_report_channel_one;
    }
    @Override
    ...
    @Override
    public void onReportChannelOneSuccess(List<ReportBean> beans) {
