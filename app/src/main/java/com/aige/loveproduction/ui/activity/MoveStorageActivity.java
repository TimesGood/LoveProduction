...
import com.aige.loveproduction.presenter.MoveStoragePresenter;
...
public class MoveStorageActivity extends BaseActivity<MoveStoragePresenter,MoveStorageContract.View> implements MoveStorageContract.View,View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        if(id == R.id.image_camera) {
            ...
            if (Build.VERSION.SDK_INT > 22) {
                if (ContextCompat.checkSelfPermission(MoveStorageActivity.this,
                        android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    //判断有没有权限 ，没有就在这里进行权限的申请
                    ActivityCompat.requestPermissions(MoveStorageActivity.this,
                            new String[]{android.Manifest.permission.CAMERA}, 1);
                } else {
                    Intent intent = new Intent(MoveStorageActivity.this, CaptureActivity.class);
