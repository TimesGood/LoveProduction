package com.aige.loveproduction.customui.viewgroup;
...
public class LineRadioGroup extends RadioGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //解析父给予的规范的参考值
        int selfWidth = View.MeasureSpec.getSize(widthMeasureSpec);
        int selfHeight = View.MeasureSpec.getSize(heightMeasureSpec);
        //记录循环下来，自己需要多宽多高
        ...
        for(int i = 0;i < childCount;i++) {
            ...
            if(lineWidthUsed +measuredHeight + mHorizontalSpacing > selfWidth) {
                //换行前记录这行的宽高
        ...
        int realWidth = (widthMode == View.MeasureSpec.EXACTLY ? selfWidth : parenNeedWidth);
        int realHeight = (heightMode == View.MeasureSpec.EXACTLY ? selfHeight : parenNeedHeight);
