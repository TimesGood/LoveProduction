...
public interface StatusAction {
    ...
    default void showEmpty() {
        showLayout(R.drawable.status_empty_ic, R.string.data_empty, null);
    }
    ...
    default void showError(View.OnClickListener listener) {
        ...
        if (manager != null) {
            ...
            if (info == null || !info.isConnected()) {
                showLayout(R.drawable.status_nerwork_ic, R.string.error_network, listener);
                return;
            }
        }
        showLayout(R.drawable.status_error_ic, R.string.error_request, listener);
    }
