package com.aige.loveproduction.permission;
...
public final class Permissions {
     ...
     * 读取外部存储
     *
     * @deprecated         在 Android 11 已经过时，请使用 {@link Permissions#MANAGE_EXTERNAL_STORAGE}
     */
    @Deprecated
    ...
    public static final class Group {
         ...
         * 存储权限
         *
         * @deprecated         在 Android 11 已经过时，请使用 {@link Permissions#MANAGE_EXTERNAL_STORAGE} 权限
         */
        @Deprecated
